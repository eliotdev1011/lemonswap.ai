...
const q = S({
    ...
    setup() {
      const { t: e } = L(),
        ...
        o = [
          {
            label: "Mail: support@lemonswap.ai",
            link: "mailto:support@lemonswap.ai",
            target: "_self",
          },
        ],
        c = [
          ...
          {
            label: e("routes.home.footer.list_service.staking"),
            link: "https://app-lemonswap-ai.vercel.app/stake",
            target: "_blank",
          },
          {
            label: e("routes.home.footer.list_service.liquid"),
            link: "https://app-lemonswap-ai.vercel.app/pools",
            target: "_blank",
          },
          {
            label: e("routes.home.footer.list_service.farm"),
